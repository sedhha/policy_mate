            ...
            <div className="pdf-viewer flex-1 overflow-auto bg-gradient-to-br from-gray-100 to-blue-100/20 p-6">
                {error ? (
                    <div className="flex flex-col items-center justify-center py-24 px-6">
                        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-red-200/50 p-8">
                            <div className="flex flex-col items-center text-center space-y-4">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium hover:from-blue-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg"
                                >
                                    Reload Page
                                </button>
                            </div>
