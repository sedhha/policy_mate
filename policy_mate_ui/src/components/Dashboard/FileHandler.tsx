...
import { AlertCircle, CheckCircle, Edit3, FileText, Upload, X, Loader2, ChevronRight, ChevronDown } from 'lucide-react';
        ...
        <>
            ...
            {!isExpanded && !fileContent ? (
                ...
                <button
                    ...
                    className="w-full group bg-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-600 rounded-2xl p-6 shadow-lg border-2 border-dashed border-slate-300 hover:border-transparent transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]"
                >
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center transition-all duration-300 shadow-lg group-hover:scale-110">
                                <Upload className="w-7 h-7 text-white transition-colors" />
                            </div>
                            <div className="text-left">
                                <p className="text-lg font-bold text-slate-800 group-hover:text-white transition-colors">
                                    Upload New Document
                                </p>
                                <p className="text-sm text-slate-600 group-hover:text-blue-100 transition-colors">
                                    Click to upload PDF files (max 5MB)
                                </p>
                            </div>
                        </div>
                        <ChevronRight className="w-6 h-6 text-slate-400 group-hover:text-white transition-all group-hover:translate-x-1" />
                    </div>
                </button>
            ) : (
                /* Expanded Upload Panel */
                <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 animate-in fade-in slide-in-from-top-4 duration-300">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button
                            ...
                            title={fileContent ? "Clear file" : "Collapse"}
                        >
                            {fileContent ? <X className="w-5 h-5 text-slate-600" /> : <ChevronDown className="w-5 h-5 text-slate-600" />}
                        </button>
                    </div>
                    ...
                    {!fileContent ? (
                        ...
                        >
                            <div className="flex flex-col items-center gap-4">
                                <div className={`w-20 h-20 bg-gradient-to-br rounded-2xl flex items-center justify-center transition-all ${dragActive
                                ...
                                <label className="cursor-pointer">
                                    <input
                                        ...
                                        className="hidden"
                                    />
                                    <span className="inline-block px-8 py-3 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105">
                                        Choose File
                                    </span>
                                </label>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="border-2 border-blue-200 rounded-xl p-5 bg-gradient-to-br from-blue-50 to-indigo-50 animate-in fade-in slide-in-from-top-2 duration-300">
                                            ...
                                            {isEditing ? (
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        className={`flex-1 px-3 py-2 border rounded-lg outline-none focus:ring-2 transition-all ${isFileNameValid
                                ...
                                {!isFileNameValid && (
                                    <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-3 animate-in fade-in slide-in-from-top-2 duration-200">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="cursor-pointer flex-1 bg-gradient-to-br from-blue-500 to-indigo-600 text-white py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
                                >
                                    {isUploading ? (
                                        <>
                            ...
                            {isUploading && uploadProgress && (
                                <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3 animate-in fade-in slide-in-from-top-2 duration-200">
